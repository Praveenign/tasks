...
/*****************************************************************************************
 *@brief this function takes two integer parameter as argument and perform addition operation and give back the result or feedback as integer
 *@parameter integer
 *@return integer
 ******************************************************************************************/
...
/*****************************************************************************************
 20  *@brief this function takes two integer parameter as argument and perform subtract operation and give back the result or feedback as integer
